...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'coastline_masker_dialog_base.ui'))


class CoastlineMaskerDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(CoastlineMaskerDialog, self).__init__(parent)
